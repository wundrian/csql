...
DbRetVal SqlOciConnection::connect (char *user, char * pass)
{
    DbRetVal rv = OK;
    char dsn[72];
...
DbRetVal SqlOciConnection::disconnect()
{
    DbRetVal rv = OK;
    /*
    SQLDisconnect (dbHdl);
...
DbRetVal SqlOciConnection::beginTrans(IsolationLevel isoLevel, TransSyncMode mode)
{
...
DbRetVal SqlOciConnection::commit()
{
    DbRetVal rv = OK;
...
DbRetVal SqlOciConnection::rollback()
{
    DbRetVal rv = OK;
