...
then
  ...
  $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/oraupdatet2.sql
  $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/oraupdatet1.sql
  $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/oraupdatet3.sql
  $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/selectstart2.sql
  $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/selectstar.sql
  $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/selectstart3.sql
else  
  if [ $DSN = "db2" ]
  then
      $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/db2updatet2.sql
      $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/db2update.sql
      $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/db2updatet3.sql
  else
      $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/updatet2.sql
      $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/update.sql
      $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/updatet3.sql
  fi
  $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/selectstart2.sql
  $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/selectstar.sql
  $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6024 -g -s $REL_PATH/selectstart3.sql
