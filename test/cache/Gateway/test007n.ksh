...
$CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6012 -g -s $REL_PATH/selectstar.sql
$CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6012 -g -s $REL_PATH/syntaxerr.sql
