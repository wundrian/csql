...
then
   ...
   $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/oracsqlinputt1.sql >/dev/null 2>&1
else
   if [ $DSN = "db2" ]
   then
       $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/csqldb2inputtest1.sql  >/dev/null 2>&1
   else
       $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/csqlinputtest1.sql  >/dev/null 2>&1
   fi
fi
...
$CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/selectstar.sql >/dev/null 2>&1 
...
then
   ...
   $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/oraselect.sql >/dev/null 2>&1
   $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/oraupdate.sql >/dev/null 2>&1
   $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/oradelete.sql >/dev/null 2>&1
   $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/selectstar.sql >/dev/null 2>&1
else
   $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/select.sql >/dev/null 2>&1 
   if [ $DSN = "db2" ]
   then
       $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/db2update.sql >/dev/null 2>&1 
   else
       $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/update.sql >/dev/null 2>&1 
   fi
   $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/delete.sql >/dev/null 2>&1 
   $CSQL_INSTALL_ROOT/bin/csql -H localhost -P 6002 -g -s $REL_PATH/selectstar.sql >/dev/null 2>&1 
fi
