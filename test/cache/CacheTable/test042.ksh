...
#     Create table t1 with field f1 int ,f2 char,f3 smallint , f4 int primary key(f1) . Make bidirectional flag and cache flag true. Cache the table with cachetable -t t1 -f f2,f3,f4 -p f4 it should pass
...
echo "create table t1(f1 int ,f2 char(12),f3 smallint , f4 bigint,primary key(f2));">$REL_PATH/t1.sql
for((a=1;a<10;a++))
do
