...
#  Create 't1' table with f1 int, f2 binary(4) ,primarykey(f1)
#  Insert some records
...
echo "create table t1 (f1 int,f2 binary(4),primary key(f1));" >${REL_PATH}/t1create.sql

for((a=1;a<=5;a++))
do
echo "insert into t1 values($a,'32eb$a');"
