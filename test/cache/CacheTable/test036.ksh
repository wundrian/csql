...
#    Create table t1 with field f1 int ,f2 char,f3 smallint , f4 bigint . Make bidirectional flag and cache flag true. Cache the table by -f f1,f2,f3 it should fail
# Author:=bijaya
