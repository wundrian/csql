...
#  4.After connect, csql goes down, then all update operations should go to MySQL directly for cached tables and MySQL tables.
...
if [ $DSN = "oracle" ]
then
   ${REL_PATH}/updateconncsqldownora  &
else
   ${REL_PATH}/updateconncsqldown  &
fi
