...
#  6c. After connect and prepare, csql goes down. it should do update for cached tables and MySQL in MySQL directly
#  non cached csql tables will fail.
...
if [ $DSN = "oracle" ]
then
   ${REL_PATH}/updateprepcsqldownora  &
else
   ${REL_PATH}/updateprepcsqldown  &
fi
