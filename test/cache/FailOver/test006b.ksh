...
#  6.After connect and prepare, csql goes down. it should do insert for cached tables and MySQL in MySQL directly
...
if [ $DSN = "oracle" ]
then
   ${REL_PATH}/insertprepcsqldownora &
else
   ${REL_PATH}/insertprepcsqldown &
fi
bgproc=$!
kill -9 $pid 
ipcrm -M 1199 -M 2277
