...
/*	if(stmt->isFldNull(1)==0)
                printf("f1=null ");
        if(stmt->isFldNull(2)==0)
                printf("f2=null ");
        if(stmt->isFldNull(3)==0)
                printf("f3=null ");
        if(stmt->isFldNull(4)==0)
                printf("f4=null ");
        if(stmt->isFldNull(5)==0)
                printf("f5=null ");
        if(stmt->isFldNull(6)==0)
                printf("f6=null ");
        if(stmt->isFldNull(71)==0)
                printf("f7=null ");
        if(stmt->isFldNull(8)==0)
                printf("f8=null ");
        if(stmt->isFldNull(9)==0)
                printf("f9=null ");
        if(stmt->isFldNull(10)==0)
                printf("f10=null ");
        if(stmt->isFldNull(11)==0)
                printf("f11=null \n");
*/
