/*Test Case : Parameterised Insert and Select on all datatypes
...
int main()
{
    ...
    stmt->setByteIntParam(9,f9var1);
    stmt->setLongLongParam(10,f10var1);
    stmt->setStringParam(11,f11var1);
    stmt->execute(rows);
