/* Test Case: Number of parameterised Field(noOfparamFields) and Getting Parameterised field info(getParamFldinfo)  
 ...
 *  select * from T1; It should display proper result
*/
