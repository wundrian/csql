...
//Fetching records after 
    ...
    printf("SELECT * FROM t1 WHERE f3=111;\n");
    strcpy(statement,"SELECT * FROM t1 WHERE f3=111;");
    rv = stmt->prepare(statement);
    stmt->bindField(1,&f1var);
    stmt->bindField(2,&f2var);
    stmt->bindField(3,&f3var);
    ...
    printf("SELECT * FROM t1 WHERE f4<3333;\n");
    strcpy(statement,"SELECT * FROM t1 WHERE f4<3333;");
    rv = stmt->prepare(statement);
    stmt->bindField(1,&f1var);
    stmt->bindField(2,&f2var);
    stmt->bindField(3,&f3var);
    ...
    printf("SELECT * FROM t1 WHERE f6<='LAKSHYA3';\n");
    strcpy(statement,"SELECT * FROM t1 WHERE f6<='LAKSHYA3';");
    rv = stmt->prepare(statement);
    stmt->bindField(1,&f1var);
    stmt->bindField(2,&f2var);
    stmt->bindField(3,&f3var);
    ...
    printf("SELECT * FROM t1 WHERE f9>'2008-08-08' and f10 <'10:10:10';\n");
    strcpy(statement,"SELECT * FROM t1 WHERE f9>'2008-08-08' and f10 <'10:10:10';");
    rv = stmt->prepare(statement);
    stmt->bindField(1,&f1var);
    stmt->bindField(2,&f2var);
    stmt->bindField(3,&f3var);
    ...
    printf("SELECT * FROM t1 WHERE f3 between 100 and 500;\n");
    strcpy(statement,"SELECT * FROM t1 WHERE f3 between 100 and 500;");
    rv = stmt->prepare(statement);
    stmt->bindField(1,&f1var);
    stmt->bindField(2,&f2var);
    stmt->bindField(3,&f3var);
    ...
    printf("SELECT * FROM t1 WHERE f6 like '%AKSHYA5';\n");
    strcpy(statement,"SELECT * FROM t1 WHERE f6 like '%AKSHYA5';");
    rv = stmt->prepare(statement);
    stmt->bindField(1,&f1var);
    stmt->bindField(2,&f2var);
    stmt->bindField(3,&f3var);
    ...
    printf("SELECT * FROM t1 WHERE f11 in ('2005-05-05 05:05:05','2006-06-06 06:06:06');\n");
    strcpy(statement,"SELECT * FROM t1 WHERE f11 in ('2005-05-05 05:05:05','2006-06-06 06:06:06');");
    rv = stmt->prepare(statement);
    stmt->bindField(1,&f1var);
    stmt->bindField(2,&f2var);
    stmt->bindField(3,&f3var);
    ...
    printf("SELECT * FROM t1 WHERE f3 is NOT NULL and f4=7777;\n");
    strcpy(statement,"SELECT * FROM t1 WHERE f3 is NOT NULL and f4=7777;");
    rv = stmt->prepare(statement);
    stmt->bindField(1,&f1var);
    stmt->bindField(2,&f2var);
    stmt->bindField(3,&f3var);
    ...
    printf("SELECT * FROM t1 WHERE f6 is NULL or not(f4=8888);\n");
    strcpy(statement,"SELECT * FROM t1 WHERE f6 is NULL or not(f4=8888);");
    rv = stmt->prepare(statement);
    stmt->bindField(1,&f1var);
    stmt->bindField(2,&f2var);
    stmt->bindField(3,&f3var);
