/*
  Default value testing with all datatypes.(TINYINT,SMALLINT,INT,BIGINT,CHAR,VARCHAR,FLOAT,DOUBLE,DATE,TIME,TIMESTAMP))
  ...
  Insert a record say (insert into t1 (f1) values(1); It should insert default values in all other fields.
  Update all the inserted default field values to null. it should update.
  Insert null values in all the fields , it should accept null values.
 It should pass.
*/
