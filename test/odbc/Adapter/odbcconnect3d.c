//   Connect the DATA SOURCE with the connection string "DSN=mycsql;MODE=ADAPTER;SERVER=127.0.0.1;PORT=5678;"
...
int main()
{
  ...
  // connect to the DSN mydsn
   ret = SQLConnect (dbc,
                   (SQLCHAR *) "DSN=mycsql;MODE=ADAPTER;SERVER=127.0.0.1;PORT=5678;", (SQLSMALLINT) strlen ("DSN=mycsql;MODE=127.0.0.1;SERVER=localhost;PORT=5678;"),
                   (SQLCHAR *) "root",
