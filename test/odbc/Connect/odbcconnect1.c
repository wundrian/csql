...
//	 DSN=mycsql;MODE=csql;SERVER=localhost;PORT=5678;
//       disconnect from the data source. It Should be Passed
...
int main()
{
  ...
  ret = SQLConnect (dbc,
                   (SQLCHAR *) "DSN=mycsql;MODE=csql;SERVER=localhost;PORT=5678;", (SQLSMALLINT) strlen ("test"),
                   (SQLCHAR *) "root",
