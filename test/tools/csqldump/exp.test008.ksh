CREATE TABLE kishor (fld1 INT  NOT NULL , name1 CHAR (32));
CREATE INDEX kishor_idx1_Primary on kishor (  fld1  )  HASH  UNIQUE;
CREATE TABLE ravi (fld2 INT  NOT NULL , name1 CHAR (32));
CREATE INDEX ravi_idx1_Primary on ravi (  fld2  )  HASH  UNIQUE;
CREATE TABLE kiran (fld3 INT  NOT NULL , name1 CHAR (32));
CREATE INDEX kiran_idx1_Primary on kiran (  fld3  )  HASH  UNIQUE;
CREATE TABLE anand (fld4 INT  NOT NULL , name1 CHAR (32));
CREATE INDEX anand_idx1_Primary on anand (  fld4  )  HASH  UNIQUE;
CREATE TABLE vikas (fld5 INT  NOT NULL , name1 CHAR (32));
CREATE INDEX vikas_idx1_Primary on vikas (  fld5  )  HASH  UNIQUE;
CREATE TABLE vikram (fld6 INT  NOT NULL , name1 CHAR (32));
CREATE INDEX vikram_idx1_Primary on vikram (  fld6  )  HASH  UNIQUE;
CREATE TABLE vinod (fld7 INT  NOT NULL , name1 CHAR (32));
CREATE INDEX vinod_idx1_Primary on vinod (  fld7  )  HASH  UNIQUE;
CREATE TABLE jayant (fld8 INT  NOT NULL , name1 CHAR (32));
CREATE INDEX jayant_idx1_Primary on jayant (  fld8  )  HASH  UNIQUE;
CREATE TABLE rahul (fld9 INT  NOT NULL , name1 CHAR (32));
CREATE INDEX rahul_idx1_Primary on rahul (  fld9  )  HASH  UNIQUE;
CREATE TABLE ramesh (fld10 INT  NOT NULL , name1 CHAR (32));
CREATE INDEX ramesh_idx1_Primary on ramesh (  fld10  )  HASH  UNIQUE;
SET AUTOCOMMIT OFF;
