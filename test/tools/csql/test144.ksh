...
# create table t3 having two integer field f5,f6 with foreign key f5 refers t1 (f1) and foreign key f6 refers t2 (f3)..It Should be passed.
#
...
$CSQL_INSTALL_ROOT/bin/csql -u root -p manager -s ${REL_PATH}/foreign144.ksh
if [ $? -ne 0 ]
then
