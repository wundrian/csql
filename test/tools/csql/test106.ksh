#!/bin/sh
# Test Case
# Create table t1 having two field f1 char and f2 int with primary key f1 and create table t2 having two field f1 char and f2 int with foreign key f1 refers t1 (f1). It should pass.
#
...
echo "CREATE TABLE t2(f1 CHAR(10),f2 INT,FOREIGN KEY(f1) REFERENCES t1(f1));" >${REL_PATH}/fkey2.sql
