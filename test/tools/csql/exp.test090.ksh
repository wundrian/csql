...
echo create table t1(f1 int not null,f2 int,f3 int);
Statement Executed
echo create index idx2 on t1(f1,f2) tree unique;
Statement Executed
echo insert into t1 values(1,2,3);
Statement Executed: Rows Affected = 1
echo insert into t1 values(1,2,4);
...
echo create table t1(f1 int not null,f2 int not null,f3 int);
Statement Executed
echo create index idx2 on t1(f1,f2) tree primary;
Statement Executed
echo insert into t1 values(1,2,3);
Statement Executed: Rows Affected = 1
echo insert into t1 values(1,2,4);
...
echo create table t1(f1 int not null,f2 int,f3 int);
Statement Executed
echo create index idx2 on t1(f1,f3) tree unique;
Statement Executed
echo insert into t1 values(1,2,3);
Statement Executed: Rows Affected = 1
echo insert into t1 values(1,4,3);
...
echo create table t1(f1 int not null,f2 int,f3 int not null);
Statement Executed
echo create index idx2 on t1(f1,f3) tree primary;
Statement Executed
echo insert into t1 values(1,2,3);
Statement Executed: Rows Affected = 1
echo insert into t1 values(1,4,3);
