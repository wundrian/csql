...
create table t2 (f1 int unique, f2 int);
...
create table t4 (f1 int, f2 int, primary key(f1));
insert into t4 values (10, 20);
insert into t4 (f1, f2) values (11, 21);
insert into t4 (f2, f1) values (22, 12);
insert into t4 (f1) values (13);
insert into t4 (f2) values (24);
select * from t4;
