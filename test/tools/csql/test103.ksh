#!/bin/sh
# Test Case
# Create table t1 having two integer field f1 ,f2 and create table t2 having two integer field f1,f2 with foreign key f1 refers t1 (f1). It should fail due to primary table referring field do not have key field
#
...
echo "CREATE TABLE t1(f1 INT,f2 INT);" >${REL_PATH}/fkey1.sql
