echo CREATE TABLE T1(f1 TINYINT AUTO_INCREMENT,f2 TINYINT);
CREATE TABLE T1(f1 TINYINT AUTO_INCREMENT,f2 TINYINT);
...
echo CREATE TABLE T2(f1 TINYINT AUTO_INCREMENT,f2 CHAR(10));
CREATE TABLE T2(f1 TINYINT AUTO_INCREMENT,f2 CHAR(10));
...
echo CREATE TABLE T4(f1 TINYINT AUTO_INCREMENT,f2 TINYINT);
CREATE TABLE T4(f1 TINYINT AUTO_INCREMENT,f2 TINYINT);
...
echo CREATE TABLE T5(f1 TINYINT AUTO_INCREMENT,f2 TINYINT NOT NULL);
CREATE TABLE T5(f1 TINYINT AUTO_INCREMENT,f2 TINYINT NOT NULL);
...
echo CREATE TABLE T6(f1 TINYINT AUTO_INCREMENT,f2 TINYINT);
CREATE TABLE T6(f1 TINYINT AUTO_INCREMENT,f2 TINYINT);
...
echo CREATE TABLE T7(f1 TINYINT AUTO_INCREMENT,f2 TINYINT,f3 TINYINT);
CREATE TABLE T7(f1 TINYINT AUTO_INCREMENT,f2 TINYINT,f3 TINYINT);
...
echo CREATE TABLE T8(f1 TINYINT AUTO_INCREMENT,f2 TINYINT,f3 TINYINT,PRIMARY KEY(f1));
CREATE TABLE T8(f1 TINYINT AUTO_INCREMENT,f2 TINYINT,f3 TINYINT,PRIMARY KEY(f1));
...
echo CREATE TABLE T9(f1 TINYINT AUTO_INCREMENT,f2 TINYINT,f3 TINYINT);
CREATE TABLE T9(f1 TINYINT AUTO_INCREMENT,f2 TINYINT,f3 TINYINT);
...
echo CREATE TABLE T10(f1 TINYINT AUTO_INCREMENT,f2 TINYINT,f3 TINYINT,PRIMARY KEY(f3,f1));
CREATE TABLE T10(f1 TINYINT AUTO_INCREMENT,f2 TINYINT,f3 TINYINT,PRIMARY KEY(f3,f1));
