#!/bin/sh
# Test Case
# Create table t1 having two integer field f1 ,f2 with primary key f1 and create table t2 having two integer field f1,f2 with foreign key f1 refers t1 (f1). It should pass.
#
...
echo "CREATE TABLE t1(f1 INT,f2 INT, PRIMARY KEY(f1));" >${REL_PATH}/fkey1.sql
