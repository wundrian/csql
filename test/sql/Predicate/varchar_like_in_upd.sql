...
echo select * from t1;
select * from t1;
echo Update t1 set f1=10, f2='CSQL1' where f2 LIKE 'ABCD%';
Update t1 set f1=10, f2='CSQL1' where f2 LIKE 'ABCD%';
echo select * from t1;
select * from t1;
echo Update t1 set f1=25, f2='CSQL2.5' where f2 LIKE '_BCD%';
Update t1 set f1=25, f2='CSQL2.5' where f2 LIKE '_BCD%';
echo select * from t1;
select * from t1;
echo Update t1 set f1=56, f2='CSQL6.5' where f2 in ('NIHAR','rahul','CSQL1');
