...
$CSQL_INSTALL_ROOT/bin/csql -s $REL_PATH/hashon_t1f1_t2f1_t3f1_treeon_t1f2_t2f1_t3f1.sql
if [ $? -ne 0 ]
then
  exit 2;
fi
...
$CSQL_INSTALL_ROOT/bin/csql -s $REL_PATH/equijoin3_with_and_t1_t2_t3.sql
if [ $? -ne 0 ]
then
  exit 4;
fi
