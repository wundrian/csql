...
echo "select * from t11 where t1.f1=2;" 
$CSQL_INSTALL_ROOT/bin/csql -s $REL_PATH/join14.sql 
if [ $? -ne 0 ]
  then
...
echo " select * from t11 where t1.f1=t1.f1;"
$CSQL_INSTALL_ROOT/bin/csql -s $REL_PATH/join15.sql
if [ $? -ne 0 ]
  then
