...
echo select t1.f1, t1.f2, t2.f1, t2.f2 from t1 inner join t2 on t1.f1 = t2.f1 ;
---------------------------------------------------------
...
echo select t1.f1, t1.f2, t2.f1, t2.f2 from t1 inner join t2 on t1.f2 = t2.f2 ;
---------------------------------------------------------
	t1.f1	t1.f2	t2.f1	t2.f2	
---------------------------------------------------------
	10	100	10	100	
...
echo select t1.f1, t1.f3, t2.f1, t2.f3 from t1 inner join t2 on t1.f3 = t2.f3 ;
---------------------------------------------------------
...
echo select t1.f1, t1.f4, t2.f1, t2.f4 from t1 inner join t2 on t1.f4 = t2.f4 ;
---------------------------------------------------------
...
echo select t1.f1, t1.f5, t2.f1, t2.f5 from t1 inner join t2 on t1.f5 = t2.f5 ;
---------------------------------------------------------
	t1.f1	t1.f5	t2.f1	t2.f5	
---------------------------------------------------------
	10	1000.000000	11	1000.000000	
	
echo select t1.f1, t1.f6, t2.f1, t2.f6 from t1 inner join t2 on t1.f6 = t2.f6 ;
---------------------------------------------------------
	t1.f1	t1.f6	t2.f1	t2.f6	
---------------------------------------------------------
	10	100000.000000	11	100000.000000	
	
echo select t1.f1, t1.f7, t2.f1, t2.f7 from t1 inner join t2 on t1.f7 = t2.f7 ;
---------------------------------------------------------
	t1.f1	t1.f7	t2.f1	t2.f7	
---------------------------------------------------------
	10	2009/3/1	10	2009/3/1	
	11	2009/3/2	13	2009/3/2	
	11	2009/3/2	11	2009/3/2	
	12	2009/3/3	16	2009/3/3	
	13	2009/3/4	17	2009/3/4	
	14	2009/3/1	10	2009/3/1	
	
echo select t1.f1, t1.f8, t2.f1, t2.f8 from t1 inner join t2 on t1.f8 = t2.f8 ;
---------------------------------------------------------
...
---------------------------------------------------------
	...
	12	11:59:57.0	13	11:59:57.0	
	12	11:59:57.0	10	11:59:57.0	
	13	11:59:59.0	16	11:59:59.0	
	14	11:59:58.0	17	11:59:58.0	
	14	11:59:58.0	11	11:59:58.0	
	
echo select t1.f1, t1.f9, t2.f1, t2.f9 from t1 inner join t2 on t1.f9 = t2.f9 ;
---------------------------------------------------------
	t1.f1	t1.f9	t2.f1	t2.f9	
---------------------------------------------------------
	10	2009/3/1 11:59:59.0	10	2009/3/1 11:59:59.0	
	11	2009/3/2 11:59:59.0	13	2009/3/2 11:59:59.0	
