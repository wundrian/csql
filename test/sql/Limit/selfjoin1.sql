...
echo SELECT emp.ename,mgr.ename FROM emp10 as emp,emp10 as mgr WHERE emp.mgrno=mgr.eno limit 3;
SELECT emp.ename,mgr.ename FROM emp10 as emp,emp10 as mgr WHERE emp.mgrno=mgr.eno limit 3;
echo SELECT emp.ename,mgr.ename FROM emp10 as emp,emp10 as mgr WHERE emp.mgrno=mgr.eno limit 2 offset 2;
SELECT emp.ename,mgr.ename FROM emp10 as emp,emp10 as mgr WHERE emp.mgrno=mgr.eno limit 2 offset 2;
