#!/bin/ksh
# Testing Left Join on two tables using IN, BETWEEN and LIKE operators with All Datatypes.
#
...
$CSQL_INSTALL_ROOT/bin/csql -s ${REL_PATH}/leftjoin_in_between_like.sql
if [ $? -ne 0 ]
then
   $CSQL_INSTALL_ROOT/bin/csql -s ${REL_PATH}/drop_t1_t2_t3.sql
   exit 2;
