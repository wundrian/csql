...
# Alter table t1 rename column f2 to f2; It should be failed.
#
...
echo "echo alter table t1 rename column f2 to f2;" >${REL_PATH}/renamecolumn.sql
echo "alter table t1 rename column f2 to f2;" >>${REL_PATH}/renamecolumn.sql
