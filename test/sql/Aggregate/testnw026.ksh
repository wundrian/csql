...
# List the productno , descriptions and their totally_ordered_quantities(sum).test  count,min,max also.  
#
...
$CSQL_INSTALL_ROOT/bin/csql -o 4 -s ${REL_PATH}/sales_join_aggregate1.sql
if [ $? -ne 0 ]
then
   $CSQL_INSTALL_ROOT/bin/csql -s ${REL_PATH}/sales_table_drop.sql
   exit 2;
