...
Network CSql
echo select sales_order_details.productno,description,qtyordered,name from sales_order_details, sales_order, product_master, client_master where sales_order.orderno=sales_order_details.orderno and product_master.productno=sales_order_details.productno and client_master.clientno=sales_order.clientno and name='Ivan Bayross' and name='Mamta Muzumdar';
---------------------------------------------------------
	sales_order_details.productno	description	qtyordered	name	
---------------------------------------------------------
	P00001	T-Shirts	4	Ivan Bayross	
	P07965	Denim Shirts	2	Ivan Bayross	
	P07885	Pull Overs	2	Ivan Bayross	
	P00001	T-Shirts	10	mamta Muzumdar	
	P07868	Trousers	3	Chhaya Bankar	
	P07885	Pull Overs	3	Chhaya Bankar	
	P00001	T-Shirts	10	Chhaya Bankar	
	P03453	Shirts	4	Chhaya Bankar	
	P03453	Shirts	2	Ivan Bayross	
	P06734	Cotton Jeans	1	Ivan Bayross	
	P07965	Denim Shirts	1	Ashwini Joshi	
	P07975	Lycra Tops	1	Ashwini Joshi	
	P00001	T-Shirts	10	Hansel Colaco	
	P07975	Lycra Tops	5	Hansel Colaco	
	
echo select sales_order_details.productno,description,min(qtyordered), max(qtyordered), count(qtyordered), sum(qtyordered) from sales_order_details, sales_order, product_master, client_master where sales_order.orderno=sales_order_details.orderno and product_master.productno=sales_order_details.productno and client_master.clientno=sales_order.clientno and name='Ivan Bayross' and name='Mamta Muzumdar' group by sales_order_details.productno,description;
---------------------------------------------------------
	sales_order_details.productno	description	MIN(qtyordered)	MAX(qtyordered)	COUNT(qtyordered)	SUM(qtyordered)	
---------------------------------------------------------
	P00001	T-Shirts	4	10	4	34	
	P07965	Denim Shirts	1	2	2	3	
	P07885	Pull Overs	2	3	2	5	
	P07868	Trousers	3	3	1	3	
	P03453	Shirts	2	4	2	6	
	P06734	Cotton Jeans	1	1	1	1	
	P07975	Lycra Tops	1	5	2	6	
