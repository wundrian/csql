...
SELECT ArticleTitle, Copyright FROM Articles  LEFT JOIN AuthorArticle  ON Articles.ArticleID=AuthorArticle.ArticleID LEFT JOIN Authors ON AuthorArticle.AuthID=Authors.AuthID ORDER BY ArticleTitle; 
