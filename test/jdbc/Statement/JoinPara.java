//select tuple with WHERE clause having param for some fields in Join(SELECT T1.f1,T2.f1,T1.f2,T2.f2,T1.f3,T2.f3 FROM T1,T2 WHERE T1.f1>=? AND T1.f2>=? AND T2.f3=?)
import java.sql.*;
public class JoinPara
{
	...
	try
	{
	    ...
	    System.out.println("SELECT T1.f1,T2.f1,T1.f2,T2.f2,T1.f3,T2.f3 FROM T1,T2;");
	    selStmt=con.prepareStatement("SELECT T1.f1,T2.f1,T1.f2,T2.f2,T1.f3,T2.f3 FROM T1,T2");
	    rs=null;
	    rs=selStmt.executeQuery();
	    ...
	    System.out.println("SELECT T1.f1,T2.f1,T1.f2,T2.f2,T1.f3,T2.f3 FROM T1,T2 WHERE T1.f1>=2 AND T1.f2>=4 AND T2.f3=6");
	    selStmt=con.prepareStatement("SELECT T1.f1,T2.f1,T1.f2,T2.f2,T1.f3,T2.f3 FROM T1,T2 WHERE T1.f1>=? AND T1.f2>=? AND T2.f3=?");
	    rs=null;
	    selStmt.setInt(1,2);
