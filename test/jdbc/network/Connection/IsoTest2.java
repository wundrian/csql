...
public class IsoTest2 
{
    public static void main(String[] args) 
    {
       try
       {
           ...
           Connection con1 = DriverManager.getConnection("jdbc:csql://localhost:5678", "root", "manager");
           Connection con2 = DriverManager.getConnection("jdbc:csql://localhost:5678", "root", "manager");
