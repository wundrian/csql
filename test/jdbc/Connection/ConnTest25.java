//Create connection, set auto-commit false, create Statement, insert 10 tuples, commit the transaction, close connection 
//Open another connection and check the number of tuples. It should be Ten.
//Author: XieLiang
import java.sql.*;
public class ConnTest25 
{
    public static void main(String[] args) 
    {
	   ...
	   System.out.println("Total rows selected " + count);
           ...
           con.close();
           if (count ==10 ) System.exit(0); else System.exit(1);
        }catch(Exception e) {
