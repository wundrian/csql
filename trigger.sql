...
FOR EACH ROW
BEGIN
Insert into csql_log_int (tablename, pkid, operation,cacheid) values ('p1', NEW.r, 1,1);
End; 
...
FOR EACH ROW
BEGIN
Insert into csql_log_int (tablename, pkid, operation,cacheid) values ('p1', OLD.r, 2,1);
Insert into csql_log_int (tablename, pkid, operation,cacheid) values ('p1', NEW.r, 1,1);
End; 
